defmodule Track.Exchanges.Bitmex.API do
  alias Track.Accounts.Scope

  @callback get_balance(scope :: Scope, currency :: String.t()) :: {:ok, list()} | {:error, term}
  ...
  defp impl, do: Application.get_env(:track, :bitmex_api_module, Track.Exchanges.Bitmex.APIImpl)
end
